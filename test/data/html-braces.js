...
, afterAmp: 'data &{{ a }} lorem'
, afterAmp2: 'data &#{{ a }} lorem'
, afterAmp3: 'data &ampi &asdf lorem'
...
, dangerousTextarea2: '<textarea>Hi & <{{ foo }} & two</textarea>'
, dangerousTextarea3: '<textarea>Hi & </{{ foo }} & two</textarea>'
, dangerousTextarea4: '<textarea>Hi & </textarea{{ foo }} & two</textarea>'
, dangerousTextarea5: '<textarea>Hi & </textarea {{ foo }} & two</textarea>'
, dangerousTextarea1b: '<textarea>Hi & </text{ foo }} & two</textarea>'
, dangerousTextarea2b: '<textarea>Hi & <{ foo }} & two</textarea>'
, dangerousTextarea3b: '<textarea>Hi & </{ foo }} & two</textarea>'
, dangerousTextarea4b: '<textarea>Hi & </textarea{ foo }} & two</textarea>'
, dangerousTextarea5b: '<textarea>Hi & </textarea { foo }} & two</textarea>'
